      ...
      <div className="max-w-6xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          <div>
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="text-xl font-bold">
                NavaShiksha<span className="text-blue-400">AI</span>
              </span>
            </div>
            <p className="text-gray-400 text-sm">
              Empowering students to achieve their dreams through smart, AI-powered exam preparation.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="text-gray-400 text-sm">support@navashiksha.ai</p>
          </div>
        </div>

        <div className="border-t border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-gray-400">
          <p>&copy; 2024 NavaShiksha AI. All rights reserved.</p>
